...
public class WebTableOrder_StepDefs {
    ...
    public void user_enters_quantity(Integer int1) {
        // default there was already number in his input
        ...
        // since sendKeys() method only accepts String, we need to either cannot with""
        // or send String.valueOg(int)
...
//        }
    ...
    public void user_should_see_in_first_row_of_the_web_table(String string) {
        String actualCustomerName = viewAllOrdersPage.newCustomerSell.getText();
